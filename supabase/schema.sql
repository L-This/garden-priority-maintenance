-- قاعدة بيانات نسخة بوابات المشاريع المستقرة
...
create policy "public read criterion photos bucket" on storage.objects for select using (bucket_id = 'criterion-photos');
create policy "public upload criterion photos bucket" on storage.objects for insert with check (bucket_id = 'criterion-photos');
