...
export const STORAGE_KEY = "garden-priority-assessments-v1";
...
export const criterionDefinitions = [
  {
    ...
    weight: 15,
    options: [
      { label: "مساحة كبيرة أكبر من 5000 م²", value: 15 },
      { label: "مساحة متوسطة أكبر من 2500 م²", value: 10 },
      { label: "مساحة منخفضة أقل من 1500 م²", value: 5 },
    ],
  },
  {
    name: "البنية التحتية",
    ...
    options: [
      { label: "خزان", value: 5 },
      { label: "شبكة ري", value: 3 },
      { label: "تربة زراعية", value: 3 },
      { label: "أشجار", value: 4 },
      { label: "عداد كهرباء", value: 5 },
    ],
  },
  {
    name: "وجود حدائق بالقرب من الموقع",
    weight: 15,
    options: [
      { label: "بعيد عن الموقع 1000 م.ط", value: 15 },
      { label: "متوسط عن الموقع 800 م.ط", value: 10 },
      { label: "قريب عن الموقع 500 م.ط", value: 5 },
    ],
  },
  {
    name: "الأرصفة أو الممرات",
    weight: 10,
    options: [
      { label: "متهالكة", value: 3 },
      { label: "متوسطة", value: 7 },
      { label: "جيدة", value: 10 },
    ],
  },
  {
    name: "الكثافة السكانية",
    weight: 15,
    options: [
      { label: "عالية", value: 15 },
      { label: "متوسطة", value: 10 },
      { label: "منخفضة", value: 5 },
    ],
  },
  {
    name: "تكلفة أعمال التطوير والتحسين",
    weight: 10,
    options: [
      { label: "عالية", value: 3 },
      { label: "متوسطة", value: 7 },
      { label: "منخفضة", value: 10 },
    ],
  },
  {
    name: "كثرة البلاغات والشكاوي",
    weight: 15,
    options: [
      { label: "عالية", value: 15 },
      { label: "متوسطة", value: 10 },
...
export const demoGardens: GardenAssessment[] = [
  {
    id: "demo-1",
    name: "حديقة الربيع",
    project: "مشروع بريمان وطيبة",
    district: "حي الربيع",
    score: 94,
    lastEvaluation: "27 أبريل 2026",
    criteria: [
  ...
  },
  {
    id: "demo-3",
    name: "حديقة السلام",
    project: "مشروع الحمدانية",
    district: "حي السلام",
    score: 69,
    lastEvaluation: "25 أبريل 2026",
    criteria: [
  ...
  },
  {
    id: "demo-4",
    name: "حديقة الأندلس",
    project: "مشروع التحلية",
    district: "حي الأندلس",
    score: 58,
    lastEvaluation: "24 أبريل 2026",
    criteria: [
      { name: "تصنيف الحديقة", weight: 15, selected: "مساحة منخفضة أقل من 1500 م²", value: 5 },
  ...
  },
  {
    id: "demo-5",
    name: "حديقة الصداقة",
    project: "مشروع الشروق",
    district: "حي الصداقة",
    score: 91,
    lastEvaluation: "27 أبريل 2026",
    criteria: [
      { name: "تصنيف الحديقة", weight: 15, selected: "مساحة كبيرة أكبر من 5000 م²", value: 15 },
      { name: "البنية التحتية", weight: 20, selected: "خزان + شبكة ري + عداد كهرباء", value: 16, photos: samplePhotos.slice(0, 2) },
      { name: "وجود حدائق بالقرب من الموقع", weight: 15, selected: "بعيد عن الموقع 1000 م.ط", value: 15 },
      { name: "الأرصفة أو الممرات", weight: 10, selected: "متهالكة", value: 8, photos: samplePhotos },
      { name: "الكثافة السكانية", weight: 15, selected: "عالية", value: 15 },
      { name: "تكلفة أعمال التطوير والتحسين", weight: 10, selected: "متوسطة", value: 7 },
      { name: "كثرة البلاغات والشكاوي", weight: 15, selected: "عالية", value: 15 },
    ],
  },
];
